...
export const WIKI_OUTLINE_PROMPT_VERSION = "v1";
...
2. EXACTLY one introductory page with audience "graduate-student-entering-field" (this is the overview replacement) — put it first in pageOrder.
